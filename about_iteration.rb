...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject is a method that takes a block and an initial value. It applies the block to each element of the array, and accumulates the result in a variable. The initial value is used as the initial value of the accumulator. The final value of the accumulator is returned.
  end
